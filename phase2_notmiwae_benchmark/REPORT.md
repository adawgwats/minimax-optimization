...
## Results — mean RMSE over 5 seeds

| Dataset | christensen_faithful | mean | MICE | missForest | paper: not-MIWAE best |
|---|---|---|---|---|---|
| banknote | **1.176** | 1.726 | 1.411 | 1.279 | 0.57 |
| concrete | **1.424** | 1.847 | 1.868 | 1.806 | 1.12 |
| red | **1.493** | 1.838 | 1.681 | 1.633 | 1.07 |
| white | 1.426 | 1.739 | **1.412** | 1.629 | 0.99 |
| yeast | **1.487** | 1.729 | 1.756 | 1.712 | 0.77 |
| breast | 1.289 | 1.820 | **0.946** | 1.486 | 0.72 |

**Bold = best among {Christensen, Mean, MICE, missForest}**. Our baselines (Mean, MICE, missForest) match the paper's reported numbers closely, confirming protocol fidelity.
...
| MICE | **4/6** | 1 | 1 |
| missForest | **6/6** | 0 | 0 |
| not-MIWAE best | 0 | 0 | 6 |

**Headline**: Christensen-faithful dominates the shallow imputers (Mean, MICE, missForest) on 4-6 of 6 datasets under not-MIWAE's MNAR protocol. Loses to not-MIWAE's deep generative approach across the board — expected, as our method is linear per-feature regression while theirs is joint deep modeling.
...
Our method is the fastest non-trivial imputer tested.
